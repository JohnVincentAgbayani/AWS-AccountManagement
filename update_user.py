...
print(f'UPDATE METHOD IS {update_method}')

env_file = open("temp_env.txt")
target_environment = env_file.read()

print(f'TARGET ENV IS {target_environment}')


# update_method = "replicate" # configure value from shell script
# target_environment = "deltekdev" # from jenkins parameters
# source_user = "johnvincentagbayani" # from jenkins parameters
# target_user = "test_reset_user" # from jenkins parameters
